$(function () {
   $('#test').submit(function () {
       ...
       .done(function (response) {
           ...
           $('#H_bs').val(response.result.HP);
           $('#A_bs').val(response.result.A);
           $('#B_bs').val(response.result.B);
           $('#C_bs').val(response.result.C);
           $('#D_bs').val(response.result.D);
           $('#S_bs').val(response.result.S);
           type1.textContent = 'タイプ１:'+response.result.type1;
           type2.textContent = 'タイプ２:'+response.result.type2;
           hcalc();
           acalc();
           bcalc();
           ccalc();
...
$(function () {
   $('#test').submit(function () {
       // Ajax通信を開始する
       console.log(document.querySelector('#list2').value);
       $.ajax({
           url: '/script/calc2.php',
           type: 'post',
           dataType: 'json', 
           data: { // 送信データを指定
               list2: $('#list2').val()
       ...
       .done(function (response) {
           console.log(response);
           $('#eH_bs').val(response.result.HP);
           $('#eA_bs').val(response.result.A);
           $('#eB_bs').val(response.result.B);
           $('#eC_bs').val(response.result.C);
           $('#eD_bs').val(response.result.D);
           $('#eS_bs').val(response.result.S);
           etype1.textContent = 'タイプ１:'+response.result.type1;
           etype2.textContent = 'タイプ２:'+response.result.type2;
           ehcalc();
           eacalc();
           ebcalc();
           eccalc();
...
function hcalc(){
    ...
    document.getElementById('H_real').textContent = H_real;
}
...
function acalc(){
    ...
    document.getElementById('A_real').textContent = A_real;
}
...
function bcalc(){
    ...
    document.getElementById('B_real').textContent = B_real;
}
...
function ccalc(){
    ...
    document.getElementById('C_real').textContent = C_real;
}
...
function dcalc(){
    ...
    document.getElementById('D_real').textContent = D_real;
}
...
function scalc(){
    ...
    document.getElementById('S_real').textContent = S_real;
}
...
function ehcalc(){
    ...
    document.getElementById('eH_real').textContent = eH_real;
}
...
function eacalc(){
    ...
    document.getElementById('eA_real').textContent = eA_real;
}
...
function ebcalc(){
    ...
    document.getElementById('eB_real').textContent = eB_real;
}
...
function eccalc(){
    ...
    document.getElementById('eC_real').textContent = eC_real;
}
...
function edcalc(){
    ...
    document.getElementById('eD_real').textContent = eD_real;
}
...
function escalc(){
    ...
    document.getElementById('eS_real').textContent = eS_real;
}
